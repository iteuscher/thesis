...
\item[HMAC (Hash-based Message Authentication Code):] Detailed in RFC 2104, this is the process of combining a secret key with a \textit{salt} and returning a sharable value. This is used as part of the \textit{PRF} performed to generate a secret used for encryption (e.g., HMAC-SHA-256). 
