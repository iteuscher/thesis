...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.92\textheight,height=0.82\textwidth,keepaspectratio]{figures/sus-violin.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.92\textheight,height=0.82\textwidth,keepaspectratio]{figures/vdl-violin.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.92\textheight,height=0.82\textwidth,keepaspectratio]{figures/ati-sus-scatter.pdf}
