...
\begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{figures/sus-violin.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{figures/vdl-violin.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{figures/ati-sus-scatter.pdf}
...
Three major themes surfaced when participants responded to questions about their trust in the security of the passwordless method: (1) participants lack a clear mental model of how passkeys work, (2) participants have high satisfaction and high trust when using biometric authentication methods, and (3) participants' trust in the brand of the tool provider impacts their trust in the overall system.

\subsubsection*{1. Lack of Understanding (Mental Model)}
...
\subsubsection*{2. Trust in Biometrics}
...
\subsubsection*{3. Platform and Brand Trust}
