...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.95\textwidth,height=0.88\textheight,keepaspectratio]{figures/sus-violin.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.95\textwidth,height=0.88\textheight,keepaspectratio]{figures/vdl-violin.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.95\textwidth,height=0.88\textheight,keepaspectratio]{figures/ati-sus-scatter.pdf}
