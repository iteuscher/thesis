...
}{figures/ui-upload.png}{File upload interface of the DocProtect application.}{fig:ui-upload}
...
}{figures/ui-identity.png}{Identity verification step with the New Passkey option and Create \& Encrypt action.}{fig:ui-identity}
...
}{figures/ui-save-passkey.png}{Save-a-passkey prompts presented by the user's passkey provider during credential creation.}{fig:ui-save-passkey}
...
}{figures/ui-use-existing.png}{The ``Use existing'' panel for selecting a previously created or third-party credential.}{fig:ui-use-existing}
...
}{figures/ui-recipients.png}{Add-recipients step of the encryption workflow.}{fig:ui-recipients}
...
}{figures/ui-share.png}{Share options presented after encryption.}{fig:ui-share}
...
}{figures/ui-decrypt.png}{Decryption-side identity step with Decrypt File action.}{fig:ui-decrypt}
...
}{figures/ui-settings.png}{Settings panel with encryption algorithm selection.}{fig:ui-settings}
...
}{figures/ui-techinfo.png}{Technical Info panel for transparency and debugging.}{fig:ui-techinfo}
