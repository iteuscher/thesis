...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{File upload interface}{fig:ui-upload}{Application's single upload interface for both encryption and decryption (image6 from research notes).}
...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{Identity, Create \& Encrypt}{fig:ui-identity}{Identity step showing the New Passkey option with Create \& Encrypt action (image7).}
...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{Save passkey prompts}{fig:ui-save-passkey}{OS-level passkey provider prompts for saving a new passkey across iCloud Keychain, Google Password Manager, Windows Hello (image8).}
...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{Use Existing credentials}{fig:ui-use-existing}{Expandable Use Existing section listing stored credentials with name and creation date (image9).}
...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{Add recipients}{fig:ui-recipients}{Optional recipients step where users add recipient email addresses individually or as a comma-separated list (image10).}
...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{Share options}{fig:ui-share}{Three sharing options---direct download of .rico file, cloud-storage upload, and shareable link (image11).}
...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{Identity, Decrypt File}{fig:ui-decrypt}{Identity step during decryption with Decrypt File action (image12).}
...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{Settings panel}{fig:ui-settings}{Settings panel with three encryption algorithm selections, collapsed by default (image13).}
...
\begin{figure}[htbp]
    \centering
    \todofigure[5in]{Technical Info panel}{fig:ui-techinfo}{Expandable Technical Info panel with algorithm setting, PRF support status, credential list, and workflow state (image14).}
