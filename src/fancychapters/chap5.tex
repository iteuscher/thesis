...
\landscapefigurepage[0.84\textheight]{figures/cloud-server-architecture.pdf}{Cloud/server-based architecture diagram.}{Cloud/server-based architecture. Alice generates the private owner key and uploads the encrypted bundle to the server, then can update permissions or contents at any time. Bob downloads the bundle, pulls the latest approved public key list, and verifies his identity to decrypt.}{fig:cloud-arch}
