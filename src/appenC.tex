...
\label{sec:sus-items}
Participants were asked to rate their immediate reaction to each tool on a 5-point Likert scale ranging from \textit{Strongly disagree} to \textit{Strongly agree}.
...
\label{sec:vdl-items}
Participants rated their immediate reaction to each tool by selecting the term that best described their experience (``I find such a system\ldots'') on a 5-point semantic-differential scale between each pair of opposing adjectives.
