\begin{udscomparisontable}
\udstablecaption{Comparison of Document Encryption Methods by Usability, Deployability, and Security Benefits}{tab:uds-comparison}
\renewcommand{\multirowsetup}{\centering\arraybackslash}
\renewcommand{\arraystretch}{1.12}
{\udscomparisontablesize
\begin{adjustbox}{max width=\udstablewidth,max height=\udscomparisontablemaxheight,center}
\begin{tabular}{C{2.15cm}C{1.5cm}M{2.15cm}L{2.4cm}cccccGccccccGcccc}
