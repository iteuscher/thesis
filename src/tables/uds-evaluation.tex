\begin{udstable}
\udstablecaption{Evaluation of Implemented System Against Design Requirements}{tab:uds-evaluation}
{\udsevaluationtablesize
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.0}
\begin{adjustbox}{max width=\udstablewidth,max height=\udsbenefitsmaxheight,center}
\begin{tabularx}{\udstablewidth}{
    >{\bfseries\centering\arraybackslash}m{0.55cm}
