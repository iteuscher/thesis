\begin{udstable}
\udstablecaption{Usability, Deployability, and Security Benefits.}{tab:evaluation-criteria}
{\udsbenefitstablesize
\setlength{\tabcolsep}{4pt}
\begin{adjustbox}{max width=\udstablewidth,max height=\udsbenefitsmaxheight,center}
\begin{tabularx}{\udstablewidth}{@{}>{\centering\arraybackslash}m{\udscatwidth} c >{\raggedright\arraybackslash}p{2.35cm} >{\raggedright\arraybackslash}X@{}}
