...
\begin{adjustbox}{max width=\textwidth,max height=\dimexpr\textheight-6\baselineskip\relax,center}
\begin{tabularx}{\textwidth}{@{}>{\centering\arraybackslash}p{\udscatwidth} c >{\raggedright\arraybackslash}p{2.15cm} >{\raggedright\arraybackslash}X@{}}
