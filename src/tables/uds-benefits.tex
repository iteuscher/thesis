...
\begin{tabularx}{\linewidth}{@{}c c >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}X@{}}
...
\noalign{\hrule height 1pt}
\noalign{\vskip 3pt}
\multirow{5}{*}{\rule{0pt}{11ex}\parbox{1.75cm}{\centering\normalsize\textbf{Usability}\\[3pt]\footnotesize How easily the primary user can perform necessary tasks.}} 
...
\noalign{\hrule height 1pt}
\noalign{\vskip 3.5pt}
\multirow{6}{*}{\rule{0pt}{14ex}\parbox{1.75cm}{\centering\normalsize\textbf{Deployability}\\[3pt]\footnotesize How easily a method can be adopted and used in real-world use cases.}} 
...
\noalign{\hrule height 1pt}
\noalign{\vskip 3pt}
\multirow{4}{*}{\rule{0pt}{8ex}\parbox{1.75cm}{\centering\normalsize\textbf{Security}\\[3pt]\footnotesize How well the method protects against unauthorized access attempts.}} 
